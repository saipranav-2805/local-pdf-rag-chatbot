 ...
 */
export declare const IndexConfigurationAnnotation: import("@langchain/langgraph")._INTERNAL_ANNOTATION_ROOT<{
    /**
 ...
 */
export declare function ensureIndexConfiguration(config: RunnableConfig): typeof IndexConfigurationAnnotation.State;
